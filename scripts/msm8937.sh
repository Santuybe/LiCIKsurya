...
if [[ "$1" == "droidspace" ]]; then
    scripts/kconfig/merge_config.sh -O out -m out/.config arch/arm64/configs/droidspacesmsm8937.config arch/arm64/configs/droidspaces-additional.config arch/arm64/configs/localversion-ds.config
